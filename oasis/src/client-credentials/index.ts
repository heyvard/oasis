...
import { withClientCredentialsCache } from "../token-cache";
 ...
 */
export const requestAzureClientCredentialsToken: ClientCredientialsProvider = withClientCredentialsCache(async (scope) =>
